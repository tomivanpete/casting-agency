...
class CastingAgencyTestCase(unittest.TestCase):
    ...
    @classmethod
    def setUpClass(cls):
        """Creates a new Casting Agency Flask app."""
        cls.app = create_app(test_config=True)
        cls.client = cls.app.test_client

        cls.database_name = 'casting-agency-test'
        cls.database_path = 'postgres://{}/{}'.format(
            'localhost:5432', cls.database_name)
    ...
    def test_get_actors(self):
        """Verifies the /api/actors endpoint for GET."""
    ...
    def test_get_actor_detail(self):
        """Verifies the /api/actors/<actor_id> endpoint for GET."""
    ...
    def test_get_movies(self):
        """Verifies the /api/movies endpoint for GET."""
    ...
    def test_get_movie_detail(self):
        """Verifies the /api/movies/<movie_id> endpoint for GET."""
        ...
        self.assertEqual(
            res_body['movie']['releaseDate'], str(
                movie.release_date))
        self.assertEqual(res_body['movie']['actors'], movie.actors)

    def test_create_actor(self):
        """Verifies the /api/actors endpoint for POST."""
    ...
    def test_create_movie(self):
        """Verifies the /api/movies endpoint for POST."""
        ...
        self.assertEqual(
            self.movie_request['releaseDate'], str(
                new_movie.release_date))

    def test_update_actor(self):
        """Verifies the /api/actors/<actor_id> endpoint for PATCH."""
    ...
    def test_update_movie(self):
        """Verifies the /api/movies/<movie_id> endpoint for PATCH."""
        actor_id = random.choice(Actor.query.all()).id
        movie_id = random.choice(Movie.query.all()).id
        ...
        res = self.client().patch(
            ...
            json=self.movie_update_request)
        self.assertEqual(res.status_code, 200)
    ...
    def test_delete_actor(self):
        """Verifies the /api/actors/<actor_id> endpoint for DELETE."""
    ...
    def test_delete_movie(self):
        """Verifies the /api/movies/<movie_id> endpoint for DELETE."""
    ...
    def test_actors_post_400(self):
        """Verifies the /api/actors endpoint for POST with 400 error."""
        res = self.client().post('/api/actors',
                                 json={'name': 'should fail with 400'})
        self.assertEqual(res.status_code, 400)

    def test_movies_post_400(self):
        """Verifies the /api/movies endpoint for POST with 400 error."""
        res = self.client().post(
            '/api/movies',
            json={
                'title': 'should fail with 400',
                'releaseDate': 'not a date'})
        self.assertEqual(res.status_code, 400)

    def test_actors_405(self):
        """Verifies the /api/actors endpoint for PUT with 405 error."""
        actor_id = random.choice(Actor.query.all()).id
    ...
    def test_movies_405(self):
        """Verifies the /api/movies endpoint for PUT with 405 error."""
        movie_id = random.choice(Movie.query.all()).id
    ...
    def test_update_actors_422(self):
        """Verifies the /api/actors endpoint for PATCH with 422 error."""
        actor_id = random.choice(Actor.query.all()).id
    ...
    def test_update_movies_422(self):
        """Verifies the /api/movies endpoint for PATCH with 422 error."""
        movie_id = random.choice(Movie.query.all()).id
    ...
    def test_get_actors_404(self):
        """Verifies the /api/actors endpoint for GET with 404 error."""
        res = self.client().get('/api/actors?page=9000')
        self.assertEqual(res.status_code, 404)

    def test_get_movies_404(self):
        """Verifies the /api/movies endpoint for GET with 404 error."""
        res = self.client().get('/api/movies?page=9000')
        self.assertEqual(res.status_code, 404)

    def test_get_actor_404(self):
        """Verifies the /api/actors/<actor_id> endpoint for GET 404 error."""
        res = self.client().get('/api/actors/9000')
        self.assertEqual(res.status_code, 404)

    def test_get_movie_404(self):
        """Verifies the /api/movies/<movie_id> endpoint for GET 404 error."""
